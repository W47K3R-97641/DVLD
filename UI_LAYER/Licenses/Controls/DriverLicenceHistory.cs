...
namespace UI_LAYER.Licenses.Controls
{
    public partial class DriverLicenceHistory : UserControl
    {
        private int _DriverID = -1;
        private clsDriver _Driver;
        private DataTable _dtDriverLocalLicensesHistory;
        private DataTable _dtDriverInternationalLicensesHistory;
        public DriverLicenceHistory()
        {
            InitializeComponent();
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            _SetInternationalHistoryColumnsSizes();
        }
        ...
        private void _SetLocalHistoryColumnsSizes()
        {
        ...
        private void _SetInternationalHistoryColumnsSizes()
        {
        ...
        private void InternationalLicenseHistorytoolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            new frmShowInternationalLicenseInfo(InternationalLicenseID).ShowDialog();
        }
        ...
        private void showLicenseInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            new frmShowLicenseInfo(LocalLicenseID).ShowDialog();
        }
    }
}
